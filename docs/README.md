...
> Welcome to the Synapse Documentation. If you are new here, start with the **Getting Started** guide.
...
Deep dives into how the core systems function.
...
### 🛠️ Other Resources
* [**Core Concepts**](./concepts.md) — The philosophy behind the architecture.
* [**Demos**](../demos/README.md) — Functional Godot projects to explore.
* [**Main Project Page**](../README.md) — Back to the repo root.
